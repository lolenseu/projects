...
if (isset($_GET['search'])) {
    ...
    // Query the database
    $sql = "SELECT id, username, email, role, verification_status
            FROM users_data 
            WHERE username LIKE '%$searchQuery%' OR email LIKE '%$searchQuery%' OR role LIKE '%$searchQuery%' OR verification_status LIKE '%$searchQuery%'
